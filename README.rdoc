...
This fork is based on cardmagic/contacts and tries to collect all patches which are useful and don't conflict with each other. I try to sync with contacts now and then, if they update.
